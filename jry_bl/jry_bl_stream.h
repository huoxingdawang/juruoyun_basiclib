...
{
	jry_bl_gc gc;						//注意，这个虽然有gc但是仍然是强制拷贝，使用gc是为了支持引用
...
typedef struct __jry_bl_stream_operater
{
	...
	void  (*usb)(jry_bl_stream*);// update stream buf
...
void			jry_bl_stream_push_char					(jry_bl_stream* this,char c);
#define			jry_bl_stream_push_char_force(this,c)	(((this)->en+1)>(this)->size)?jry_bl_stream_do(this,0):0,(this)->buf[(this)->en++]=c
