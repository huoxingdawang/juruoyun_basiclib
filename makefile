...
jry_bl/jry_bl_cmd			:jry_bl/jry_bl_ying jry_bl/jry_bl_exception jry_bl/jry_bl_malloc jry_bl/jry_bl_string
	$(CC) $(EX) -c -std=gnu99 -o tmp$(H)jry_bl_cmd.o jry_bl$(H)jry_bl_cmd.c	$(JRY_BL_EXLIB)
jry_bl/jry_bl_exception		:jry_bl/jry_bl_ying 
	$(CC) $(EX) -c -std=gnu99 -o tmp$(H)jry_bl_exception.o jry_bl$(H)jry_bl_exception.c $(JRY_BL_EXLIB)
jry_bl/jry_bl_file			:jry_bl/jry_bl_ying jry_bl/jry_bl_exception jry_bl/jry_bl_malloc jry_bl/jry_bl_string jry_bl/jry_bl_var jry_bl/jry_bl_hash_table
	$(CC) $(EX) -c -std=gnu99 -o tmp$(H)jry_bl_file.o jry_bl$(H)jry_bl_file.c $(JRY_BL_EXLIB)
jry_bl/jry_bl_hash_table	:jry_bl/jry_bl_ying jry_bl/jry_bl_exception jry_bl/jry_bl_malloc jry_bl/jry_bl_string jry_bl/jry_bl_var
...
jry_bl/jry_bl_stream		:jry_bl/jry_bl_ying jry_bl/jry_bl_exception jry_bl/jry_bl_malloc
	$(CC) $(EX) -c -std=gnu99 -o tmp$(H)jry_bl_stream.o jry_bl$(H)jry_bl_stream.c $(JRY_BL_EXLIB)
jry_bl/jry_bl_string		:jry_bl/jry_bl_ying jry_bl/jry_bl_exception jry_bl/jry_bl_malloc
	$(CC) $(EX) -c -std=gnu99 -o tmp$(H)jry_bl_string.o jry_bl$(H)jry_bl_string.c $(JRY_BL_EXLIB)
jry_bl/jry_bl_time		:jry_bl/jry_bl_ying jry_bl/jry_bl_exception jry_bl/jry_bl_malloc
...
jry_bl/jry_bl_ying			:
	$(CC) $(EX) -c -std=gnu99 -o tmp$(H)jry_bl_ying.o jry_bl$(H)jry_bl_ying.c $(JRY_BL_EXLIB)
