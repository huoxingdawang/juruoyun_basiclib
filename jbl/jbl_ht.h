...
jbl_string *			jbl_ht_json_encode			(const jbl_ht* this,jbl_string *out,jbl_uint8 format,jbl_int32 tabs);	//JSON 编码
jbl_ht*					jbl_ht_json_decode			(jbl_ht *this,jbl_string* in,jbl_string_size_type *start);	//JSON 解码
#if JBL_STREAM_ENABLE==1
void					jbl_ht_json_put				(const jbl_ht* this,jbl_stream *out,jbl_uint8 format,jbl_int32 tabs);	//从out JSON输出一个hash table
#endif
#endif
/*******************************************************************************************/
/*                            以下函实现哈希表浏览操作                                   */
/*******************************************************************************************/
#if JBL_STREAM_ENABLE==1
jbl_ht*					jbl_ht_view_put						(jbl_ht* this,jbl_stream *out,jbl_uint8 format,jbl_uint32 tabs,jbl_int32 line,unsigned char * varname,unsigned char * func,unsigned char * file);	//从out浏览一个hash table
