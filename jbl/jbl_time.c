/* Generated by re2c 1.3 on Tue Jul 28 23:27:51 2020 */
...
jbl_time_key __jbl_time_key_scaner(unsigned char * YYCURSOR,unsigned char * YYLIMIT,unsigned char **addr)
{
...
/*                            以下函实现时间对字符串操作                                */
/*******************************************************************************************/
jbl_string * jbl_time_to_string_format(const jbl_time *this,jbl_string *result,unsigned char * format)
{
	jbl_time_decoded tt;
	...
	while((key=__jbl_time_key_scaner(format+i,format+n,&addr))!=JBL_TIME_KEY_END)
	{
		...
		switch(key)
		{
			...
			case JBL_TIME_KEY_DOM		:result=jbl_string_add_uint64(result,tt.day)					;break;
			case JBL_TIME_KEY_DOMWZ		:result=jbl_string_add_uint64_length(result,tt.day,2,'0')		;break;
			...
			case JBL_TIME_KEY_DOWN		:result=jbl_string_add_uint64(result,tt.week)					;break;
			case JBL_TIME_KEY_DOWNF0	:result=jbl_string_add_uint64(result,tt.week-1)					;break;
			...
			case JBL_TIME_KEY_MNWZ		:result=jbl_string_add_uint64_length(result,tt.month,2,'0')		;break;
			case JBL_TIME_KEY_M3		:result=jbl_string_add_chars(result,UC m3[tt.month-1])			;break;	
			case JBL_TIME_KEY_MN		:result=jbl_string_add_uint64(result,tt.month)					;break;	
			case JBL_TIME_KEY_TDOM		:result=jbl_string_add_uint64(result,tt.dom)					;break;			

			case JBL_TIME_KEY_YILY		:result=jbl_string_add_uint64(result,tt.isleap)					;break;
			case JBL_TIME_KEY_Y			:result=jbl_string_add_uint64_length(result,tt.year,4,'0')		;break;
			case JBL_TIME_KEY_YISO		:break;
			case JBL_TIME_KEY_Y2		:result=jbl_string_add_uint64_length(result,tt.year%100,2,'0')	;break;	
			...
			case JBL_TIME_KEY_H12		:result=jbl_string_add_uint64(result,tt.hour%12)				;break;
			case JBL_TIME_KEY_H12WZ		:result=jbl_string_add_uint64_length(result,tt.hour%12,2,'0')	;break;
			case JBL_TIME_KEY_H24		:result=jbl_string_add_uint64(result,tt.hour)					;break;
			case JBL_TIME_KEY_H24WZ		:result=jbl_string_add_uint64_length(result,tt.hour,2,'0')		;break;
			case JBL_TIME_KEY_MWZ		:result=jbl_string_add_uint64_length(result,tt.minute,2,'0')	;break;
			case JBL_TIME_KEY_SWZ		:result=jbl_string_add_uint64_length(result,tt.second,2,'0')	;break;
			case JBL_TIME_KEY_MSWZ		:result=jbl_string_add_uint64_length(result,tt.ms,2,'0')		;break;
			...
			case JBL_TIME_KEY_S			:result=jbl_string_add_uint64(result,this->t/1000)				;break;
...
{
	return jbl_time_to_string_format(this,result,"Y-m-d H:i:s D");
}
#endif
...
{
	jbl_string *s1=jbl_time_to_string_format(this,NULL,"Y-m-d H:i:s D");
