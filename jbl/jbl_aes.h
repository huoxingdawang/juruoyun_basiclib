...
/*******************************************************************************************/
jbl_string *	jbl_aes_128_ecb_encode					(jbl_aes_128_key *key,jbl_string *this,jbl_string *result);						//进行AES128ECB加密
jbl_string *	jbl_aes_128_ecb_decode					(jbl_aes_128_key *key,jbl_string *this,jbl_string *result);						//进行AES128ECB解密
#endif
...
jbl_stream *                     jbl_stream_aes_128_ecb_encode_new      (jbl_aes_128_key *w);
jbl_stream *                     jbl_stream_aes_128_ecb_decode_new      (jbl_aes_128_key *w);
...
/*******************************************************************************************/
jbl_string *	jbl_aes_128_cbc_encode					(jbl_aes_128_key *key,unsigned char *vi,jbl_string *this,jbl_string *result);	//进行AES128CBC加密
jbl_string *	jbl_aes_128_cbc_decode					(jbl_aes_128_key *key,unsigned char *vi,jbl_string *this,jbl_string *result);	//进行AES128CBC解密
#if JBL_STREAM_ENABLE==1
/*******************************************************************************************/
...
jbl_stream * jbl_stream_aes_128_cbc_encode_new(jbl_aes_128_key *key,const unsigned char * v);
jbl_stream * jbl_stream_aes_128_cbc_decode_new(jbl_aes_128_key *key,const unsigned char * v);
