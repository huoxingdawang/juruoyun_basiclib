...
typedef struct __jbl_var_operators
{
	...
	jbl_string*	(*json_encode)(const void*,jbl_string *,jbl_uint8,jbl_int32);
#endif
#endif	
#if JBL_STREAM_ENABLE==1
	void *	(*view_put)(void*,jbl_stream *,jbl_uint8,jbl_int32,jbl_uint32 line,unsigned char*,unsigned char *,unsigned char *);
#if JBL_JSON_ENABLE==1
	void	(*json_put)(const void*,jbl_stream *,jbl_uint8,jbl_int32);
#endif
#endif
}jbl_var_operators;
			...
			const jbl_var_operators name={															\
				...
				(jbl_string*(*)(const void*,jbl_string *,jbl_uint8,jbl_int32))json_encode,				\
				(void* (*)(void*,jbl_stream *,jbl_uint8,jbl_int32,jbl_uint32 line,unsigned char*,unsigned char *,unsigned char *))view_put,				\
				(void(*)(const void*,jbl_stream *,jbl_uint8,jbl_int32))json_put,							\
			};
		#else
...
#if JBL_STREAM_ENABLE==1
jbl_var *	jbl_var_view_put				(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_uint32 tabs,jbl_int32 line,unsigned char * varname,unsigned char * func,unsigned char * file);	//从out浏览一个var
...
#if JBL_JSON_ENABLE==1
void 		jbl_var_json_put				(jbl_var * this,jbl_stream *out,jbl_uint8 format,jbl_int32 tabs);	//从从out JSON格式化一个var
#endif
#endif
...
#if JBL_JSON_ENABLE==1
jbl_string *	jbl_var_json_encode			(jbl_var * this,jbl_string *out,jbl_uint8 format,jbl_int32 tabs);	//JSON编码一个var
...
#if JBL_STRING_ENABLE==1
#if JBL_JSON_ENABLE==1
jbl_string * 	jbl_Vuint_json_encode		(jbl_var* this,jbl_string *out,jbl_uint8 format,jbl_int32 tabs);	//JSON编码一个var格式的uint
jbl_string * 	jbl_Vint_json_encode		(jbl_var* this,jbl_string *out,jbl_uint8 format,jbl_int32 tabs);	//JSON编码一个var格式的int
jbl_string * 	jbl_Vdouble_json_encode		(jbl_var* this,jbl_string *out,jbl_uint8 format,jbl_int32 tabs);	//JSON编码一个var格式的double
jbl_string *	jbl_Vntf_json_encode		(jbl_var* this,jbl_string *out,jbl_uint8 format,jbl_int32 tabs);	//JSON编码一个var格式的null或true或false
#endif
#endif
#if JBL_STREAM_ENABLE==1
jbl_var * 		jbl_Vuint_view_put			(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_uint32 tabs,jbl_int32 line,unsigned char * varname,unsigned char * func,unsigned char * file);	//从从out 浏览一个var格式的uint
jbl_var * 		jbl_Vint_view_put			(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_uint32 tabs,jbl_int32 line,unsigned char * varname,unsigned char * func,unsigned char * file);	//从从out 浏览一个var格式的int
jbl_var * 		jbl_Vdouble_view_put		(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_uint32 tabs,jbl_int32 line,unsigned char * varname,unsigned char * func,unsigned char * file);	//从从out 浏览一个var格式的double
jbl_var *		jbl_Vntf_view_put			(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_uint32 tabs,jbl_int32 line,unsigned char * varname,unsigned char * func,unsigned char * file);	//从从out 浏览一个var格式的null或true或false
#if JBL_JSON_ENABLE==1
void 			jbl_Vuint_json_put			(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_int32 tabs);	//从从out JSON格式化一个var格式的uint
void 			jbl_Vint_json_put			(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_int32 tabs);	//从从out JSON格式化一个var格式的int
void 			jbl_Vdouble_json_put		(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_int32 tabs);	//从从out JSON格式化一个var格式的double
void			jbl_Vntf_json_put			(jbl_var* this,jbl_stream *out,jbl_uint8 format,jbl_int32 tabs);	//从从out JSON格式化一个var格式的null或true或false
#endif
#endif
