/* Generated by re2c 1.3 on Mon Aug 10 23:39:17 2020 */
...
const jbl_var_operators * jbl_var_scanner(unsigned char * YYCURSOR,unsigned char *YYLIMIT,unsigned char **addr)
{
	...
	#define YYFILL(n)	return (const jbl_var_operators *)JBL_VAR_SCANNER_KEY_END;
    
#line 192 "jbl/jbl_var.c"
{
	YYCTYPE yych;
...
#line 189 "jbl/jbl_var.l"
	{if(addr)*addr=YYCURSOR;return (const jbl_var_operators *)JBL_VAR_SCANNER_KEY_UNDEFINED;}
#line 206 "jbl/jbl_var.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'X':	goto yy5;
...
#line 194 "jbl/jbl_var.l"
	{if(addr)*addr=YYCURSOR;return (const jbl_var_operators *)JBL_VAR_SCANNER_KEY_HEX;}
#line 221 "jbl/jbl_var.c"
yy7:
	++YYCURSOR;
#line 193 "jbl/jbl_var.l"
	{if(addr)*addr=YYCURSOR;return (const jbl_var_operators *)JBL_VAR_SCANNER_KEY_CHAR;}
#line 226 "jbl/jbl_var.c"
yy9:
	++YYCURSOR;
#line 190 "jbl/jbl_var.l"
	{if(addr)*addr=YYCURSOR;return (const jbl_var_operators *)JBL_VAR_SCANNER_KEY_INT;}
#line 231 "jbl/jbl_var.c"
yy11:
	++YYCURSOR;
#line 191 "jbl/jbl_var.l"
	{if(addr)*addr=YYCURSOR;return (const jbl_var_operators *)JBL_VAR_SCANNER_KEY_DOUBLE;}
#line 236 "jbl/jbl_var.c"
yy13:
	++YYCURSOR;
#line 192 "jbl/jbl_var.l"
	{if(addr)*addr=YYCURSOR;return (const jbl_var_operators *)JBL_VAR_SCANNER_KEY_CHARS;}
