...
void *			jbl_refer_pull_unwrlock				(void *ptr){while(ptr&&jbl_gc_is_ref((jbl_reference*)ptr))jbl_pthread_lock_unwrlock(((jbl_reference*)ptr)),ptr=((jbl_reference*)ptr)->ptr;if(ptr)jbl_pthread_lock_unwrlock(((jbl_reference*)ptr));return (void*)ptr;}
void *			jbl_refer_pull_unrdlock				(void *ptr){while(ptr&&jbl_gc_is_ref((jbl_reference*)ptr))jbl_pthread_lock_unrdlock(((jbl_reference*)ptr)),ptr=((jbl_reference*)ptr)->ptr;if(ptr)jbl_pthread_lock_unrdlock(((jbl_reference*)ptr));return (void*)ptr;}
