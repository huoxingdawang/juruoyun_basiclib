...
void *			jbl_refer_pull_keep_father_rwlock	(void *ptr,jbl_reference** ref){jbl_reference* reff=NULL;while(ptr&&jbl_gc_is_ref((jbl_reference*)ptr))reff=(jbl_reference*)ptr,jbl_pthread_lock_wrlock(reff),ptr=((jbl_reference*)ptr)->ptr;if(ref)*ref=reff;if(ptr)jbl_pthread_lock_wrlock(((jbl_reference*)ptr));return (void*)ptr;}
