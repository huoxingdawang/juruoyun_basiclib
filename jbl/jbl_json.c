/* Generated by re2c 1.3 on Tue Sep 15 16:08:34 2020 */
...
yy22:
	yy->cond = (jbl_json_condition_num);
#line 93 "jbl/jbl_json.l"
	{upd;yy->v=jbl_var_free(yy->v);yy->tmp.u=*(YYCURSOR-1)-'0';yy->f=1							;goto yyc_num;}
#line 275 "jbl/jbl_json.c"
yy23:
	++YYCURSOR;
	goto yy22;
yy24:
	++YYCURSOR;
#line 196 "jbl/jbl_json.l"
	{
...
#line 309 "jbl/jbl_json.c"
yy28:
	++YYCURSOR;
#line 152 "jbl/jbl_json.l"
	{
																	if(yy->type==ARRAY)
																	{
																		upd;
...
#line 364 "jbl/jbl_json.c"
yy36:
	++YYCURSOR;
#line 178 "jbl/jbl_json.l"
	{
...
#line 106 "jbl/jbl_json.l"
	{upd																						;goto yyc_string_turn;}
#line 482 "jbl/jbl_json.c"
/* *********************************** */
yyc_string_turn:
	yy->state = (2);
	if (YYLIMIT <= YYCURSOR) {upd;return yy;}
...
#line 115 "jbl/jbl_json.l"
	{upd;																						;goto yyc_string;}
#line 505 "jbl/jbl_json.c"
yy65:
	++YYCURSOR;
#line 250 "jbl/jbl_json.l"
	{yy->cond=-3;return yy;}
#line 510 "jbl/jbl_json.c"
yy67:
	++YYCURSOR;
	yy->cond = (jbl_json_condition_string);
...
//	jbl_stream* nxt=jbl_refer_pull(this->nxt);
	...
	if((!this->stop)&&this->en)
	{
		...
		if(((struct __jbl_json_decode_yy*)this->data)->cond==(jbl_uint8)-1){this->stop=1;return;}
	}
