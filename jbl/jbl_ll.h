...
#define	         jbl_ll_delete_head(x)		jbl_ll_delete(x,NULL)			            //删除头
#define	         jbl_ll_delete_tail(x)		jbl_ll_delete(x,((void *)-1))			    //删除尾
/*******************************************************************************************/
/*                            以下函实现链表获取操作                                      */
/*******************************************************************************************/
jbl_ll_size_type jbl_ll_get_length          (jbl_ll *this);							//获取一个link list的长度
