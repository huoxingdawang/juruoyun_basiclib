...
#define					jry_bl_string_equal_string(this,in)					jry_bl_string_clear(this),jry_bl_string_add_string(this,in)
...
#define					jry_bl_string_equal_long_long(this,in)				jry_bl_string_clear(this),jry_bl_string_add_long_long(this,in)
#define					jry_bl_string_equal_unsigned_long_long(this,in)		jry_bl_string_clear(this),jry_bl_string_add_unsigned_long_long(this,in)
