...
void	jry_bl_string_equal_char_pointer		(jry_bl_string *this,char *in);
void	jry_bl_string_equal_char_pointer_length	(jry_bl_string *this,char *in,jry_bl_string_size_type len);
void	jry_bl_string_equal_char				(jry_bl_string *this,char in);
...
char* 	jry_bl_string_get_char_pointer			(jry_bl_string *this);
...
void	jry_bl_string_equal_file_end_by			(jry_bl_string *this,FILE * file,char end);
#endif
#if JRY_BL_STRING_USE_STDARG==1
