...
const jry_bl_uint8 jry_bl_time_day_per_month[12]={31,28,31,30,31,30,31,31,30,31,30,31};
jry_bl_uint8 jry_bl_time_if_leap_year(jry_bl_uint32 year);inline jry_bl_uint8 jry_bl_time_if_leap_year(jry_bl_uint32 year){return (((year%400)==0)?1:(((year%100)==0)?0:(((year%4)==0)?1:0)));}
jry_bl_uint8 jry_bl_time_get_day_of_month(jry_bl_uint8 month, jry_bl_uint32 year);inline jry_bl_uint8 jry_bl_time_get_day_of_month(jry_bl_uint8 month, jry_bl_uint32 year){return (month==2||(month==0)||(month>12))?(jry_bl_time_day_per_month[1]+jry_bl_time_if_leap_year(year)):(jry_bl_time_day_per_month[month-1]);}
void jry_bl_time_to_string(jry_bl_time *this,jry_bl_string *result)
{
	...
	ts+=jry_bl_time_time_zone*3600000;
	if(ts>0)
	{
